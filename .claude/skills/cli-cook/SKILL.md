---
name: cli-cook
description: "(ePost) Implement CLI features in the epost-agent-cli project"
user-invocable: true
context: fork
...
Activate the `kit-cli` skill for domain context (architecture, patterns, key modules).
