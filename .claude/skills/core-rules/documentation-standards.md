...
- [Formatting Rules](#formatting-rules) — Line 15
- [Required Structure](#required-structure) — Line 35
- [Content Guidelines](#content-guidelines) — Line 55
- [Size Limits](#size-limits) — Line 75
- [Auto-Update Behavior](#auto-update-behavior) — Line 90
...
6. No user confirmation needed for documentation updates
