...
- [Autonomous Actions](#autonomous-actions) — Line 15
- [Requires Approval](#requires-approval) — Line 35
- [Escalation Rules](#escalation-rules) — Line 55
- [Option Presentation](#option-presentation) — Line 75
