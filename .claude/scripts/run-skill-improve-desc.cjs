 ...
 *
 * Usage:
 *   node scripts/run-skill-improve-desc.cjs <skill-path>
 *   npm run skill:improve-desc -- <skill-path>
 *
...
function printUsage() {
  console.error('Usage: node run-skill-improve-desc.cjs <skill-path>');
  console.error('');
  console.error('Examples:');
  console.error('  node run-skill-improve-desc.cjs .claude/skills/cook');
  console.error('');
