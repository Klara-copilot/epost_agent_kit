 ...
 *
 * Usage:
 *   node scripts/run-skill-optimize.cjs <skill-path> --eval-set <path> [options]
 *   npm run skill:optimize -- <skill-path> --eval-set <path> [options]
 *
 * Options:
...
function printUsage() {
  console.error('Usage: node run-skill-optimize.cjs <skill-path> --eval-set <path> [--model <id>] [--max-iterations 5] [--verbose]');
  console.error('');
  console.error('Examples:');
  console.error('  node run-skill-optimize.cjs .claude/skills/cook --eval-set /tmp/ws/trigger-eval.json');
  console.error('  node run-skill-optimize.cjs .claude/skills/plan --eval-set eval.json --max-iterations 3 --verbose');
  console.error('');
