...
function loadSkillNames() {
  try {
    ...
    return [
      'skill-discovery', 'knowledge', 'journal', 'cook', 'plan',
      'debug', 'core', 'fix', 'test', 'docs', 'audit', 'review',
      'git', 'thinking', 'web-frontend', 'web-nextjs', 'web-api-routes',
      'backend-javaee', 'design-tokens', 'figma',
