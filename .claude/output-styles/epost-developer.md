...
Use `##` headers to organize response into clear sections. Never write long unstructured paragraphs.
...
## Tables Over Lists
Prefer tables for structured comparisons, option analysis, or multi-field data.

## File References
When referencing files, use relative paths from project root (e.g., `src/components/Button.tsx`).
