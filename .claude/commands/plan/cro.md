...
- If the user provides a screenshots or videos, use `ai-multimodal` skill to describe as detailed as possible the issue, make sure epost-copywriter can fully understand the issue easily based on the description.
...
- Use `epost-architect` agent to create a comprehensive CRO plan following the progressive disclosure structure:
