...
### TODO: Add component-authoring.md to web-ui-lib SKILL.md

Already covered in Phase 2 task — verify it was done.
...
|------|--------|
| `packages/core/skills/audit/references/ui.md` | Modify — update Step 2 text |
| `packages/design-system/skills/ui-lib-dev/SKILL.md` | Modify — add audit-standards aspects row |
| `packages/core/skills/audit/SKILL.md` | Modify — add ui-lib-dev to enhances |
| `packages/platform-web/skills/web-ui-lib/SKILL.md` | Modify — add component-authoring aspects row |
