...
- [Image Basics](#image-basics) → Lines 10-50
- [Decorative Images](#decorative-images) → Lines 52-90
- [Informative Images](#informative-images) → Lines 92-130
- [Image Labels](#image-labels) → Lines 132-170
- [Complex Images](#complex-images) → Lines 172-200
- [Image Buttons](#image-buttons) → Lines 202-230

## Related Documents

- [a11y-core](./a11y-core.mdc) - Core accessibility principles
- [a11y-buttons](./a11y-buttons.mdc) - Button accessibility
- [a11y-colors-contrast](./a11y-colors-contrast.mdc) - Visual accessibility
