...
- [Focus Basics](#focus-basics) → Lines 10-40
- [Focus Announcements](#focus-announcements) → Lines 42-80
- [Focus Order](#focus-order) → Lines 82-120
- [Programmatic Focus](#programmatic-focus) → Lines 122-150
- [Screen Changes](#screen-changes) → Lines 152-180
- [Dynamic Content](#dynamic-content) → Lines 182-210

## Related Documents

- [a11y-core](./a11y-core.mdc) - Core accessibility principles
- [a11y-headings](./a11y-headings.mdc) - Heading navigation
- [a11y-forms](./a11y-forms.mdc) - Form focus
