...
Activate relevant skills from `.github/skills/` based on task context.
...
**IMPORTANT**: Analyze skills at `.github/skills/*` and activate skills needed during the task.
...
- `.github/skills/planning/SKILL.md` — Planning workflow, templates, and storage protocol
- `.github/skills/doc-coauthoring/SKILL.md` — Structured documentation workflow
- `.github/skills/core/SKILL.md` — Operational boundaries
