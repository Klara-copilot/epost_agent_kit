 ...
 *
 * Blocks access to directories listed in .github/.ckignore
 ...
 *
 * Configuration:
 * - Edit .github/.ckignore to customize blocked patterns (one per line, # for comments)
...
try {
  ...
  const claudeDir = path.dirname(__dirname); // Go up from hooks/ to .github/
