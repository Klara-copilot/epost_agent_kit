...
3. **Security Scan** — No secrets detected (`node .github/scripts/scan-secrets.cjs`)
4. **Coverage Gate** — 80%+ coverage (`node .github/scripts/check-coverage.cjs`)
