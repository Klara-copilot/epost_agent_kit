...
context: fork
model: haiku
allowed-tools: Read, Write, Bash(node packages/core/scripts/detect-improvements.cjs), Bash(node .github/scripts/detect-improvements.cjs), Bash(ls *), Bash(wc *), Bash(date *)
---
...
```bash
node packages/core/scripts/detect-improvements.cjs 2>/dev/null || node .github/scripts/detect-improvements.cjs
```
...
```
Write to .epost-data/improvements/last-summary.json:
