...
> These rules apply to documentation files. Agent response formatting is defined in `.github/output-styles/`.
...
**Migration Context:**
- Feb 2026: Migrated 18 of 36 epost-kit skills to this structure
