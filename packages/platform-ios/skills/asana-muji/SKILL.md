---
name: asana-muji
description: "Use when: \"create task\", \"update status\", \"move task\", \"asana\", \"muji task\", \"board update\", \"my tasks\". Asana workflow for MUJI iOS: create/update tasks across iOS Libraries, MUJI Tasks, and MUJI Plan boards."
