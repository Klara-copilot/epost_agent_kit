...
def find_api_key() -> Optional[str]:
    ...
    """
    # Priority 1: Already in process environment (highest)
    ...
    if load_dotenv:
        ...
        skill_dir = script_dir.parent  # packages/core/skills/media-ai

        # Priority 2: Project root .env (walk up to find it)
