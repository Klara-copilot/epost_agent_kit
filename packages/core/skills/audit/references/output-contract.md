...
|------------|----------------|-------------|
| Hybrid (code-reviewer + muji) | `reports/{YYMMDD-HHMM}-{slug}-audit/` | main context (audit/SKILL.md) |
...
```json
{
  ...
  "agents": [
    { "name": "epost-muji", "report": "muji-ui-audit.md", "verdict": "FIX-AND-RESUBMIT", "findings": { "critical": 6, "high": 11, "medium": 10, "low": 6 } },
...
Code-reviewer reads this table, extracts files + issues, fills Template B for epost-a11y-specialist.
...
|---------------|---------|-------|
| `ui-lib-dev/references/audit-standards.md` | epost-muji | UI library + consumer code (STRUCT, PROPS, TOKEN, BIZ, A11Y, TEST, EMBED, LDRY, INT, PLACE, REUSE, TW, DRY, REACT, POC) |
| `code-review/references/code-review-standards.md` | epost-code-reviewer | General code (SEC, PERF, TS, LOGIC, DEAD, ARCH, STATE) |
