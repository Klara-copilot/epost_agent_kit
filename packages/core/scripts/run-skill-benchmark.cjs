 ...
 *
 * Usage:
 *   node scripts/run-skill-benchmark.cjs <workspace/iteration-N> [--skill-name <name>]
 *   npm run skill:benchmark -- <workspace/iteration-N> [--skill-name <name>]
 *
...
function printUsage() {
  console.error('Usage: node run-skill-benchmark.cjs <workspace/iteration-N> [--skill-name <name>]');
  console.error('');
  console.error('Examples:');
  console.error('  node run-skill-benchmark.cjs /tmp/skill-ws/iteration-1 --skill-name cook');
  console.error('');
