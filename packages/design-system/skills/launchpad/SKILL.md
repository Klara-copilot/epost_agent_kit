---
name: launchpad
description: "(ePost) Use when building landing pages, promotional sites, or marketing pages. Craft-first, not templates. Routes to epost-muji for design then epost-fullstack-developer for implementation."
...
This skill MUST run via `epost-muji`, not inline.
...
Apply `references/craft-principles.md` throughout. See `references/launchpad-workflow.md` for typography, brand tokens, spacing patterns, and sections-as-chapters structure.
...
See `references/launchpad-workflow.md` for the full avoid list.
...
| `references/launchpad-workflow.md` | Build execution: typography/tokens/spacing patterns, sections structure, avoid list |
