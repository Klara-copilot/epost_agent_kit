...
Utility to clean text for indexing or search.

**Parameters**:
- `text` (string): Text to sanitize
- `preserve_code` (boolean): Whether to preserve code formatting
...
- `muji/klara-theme` — Component API knowledge
- `web/klara-theme` — Figma-to-code pipeline
