# Changelog: platform-web

All notable changes to the `platform-web` package will be documented in this file.
...
- Added `epost-web-developer` — Web platform specialist for Next.js, React, TypeScript development
...
- Added `/web:cook` — Implement web features (Next.js, React, TypeScript)
- Added `/web:test` — Run web tests (Jest, Playwright, React Testing Library)
