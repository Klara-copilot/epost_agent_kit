...
// POST /api/rag/sidecar
{
  file_path: "libs/klara-theme/src/components/[Component]/[Component].tsx",
  metadata: {
    summary: "1-2 sentences describing what the component does",
    component_names: ["ComponentName", "ComponentProps"],
    topics: ["ui", "design-system"],
    exports: ["ComponentName", "componentVariants"],
    dependencies: ["@radix-ui/react-slot"],
    design_tokens: ["--component-bg", "--component-text"],
    hooks_used: ["useComponentContext"]
  }
}
```
...
| `topics` | 2-4 relevant topic tags (discover valid values via `status`) | `["ui", "design-system", "overlay"]` |
